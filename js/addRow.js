...
function addRow() {
    ...
    $('#tableBody').append('<tr>' +
        ...
        '<td><select names="Confirms" id="confirm' + rowNum + '" class="dropdown">/td><option value="Confirm">Confirm</option><option value="Overrule">Overrule</option><option value="Not Given">Not Given</option><option value="Given">Given</option>' +
