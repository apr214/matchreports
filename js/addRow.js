...
function addRow() {
    ...
    $('#tableBody').append('<tr>' +
        ...
        '<td><select names="type" id="inc_type' + rowNum + '" class="dropdown">/td><option value="RED">RED</option><option value="PENALTY">PENALTY</option><option value="GOAL">GOAL</option><option value="Mistaken Identy">Mistaken Identy</option>' +
        ...
        '<td><select names="Training" class="dropdown" id="training' + rowNum + '">/td><option value="YES">YES</option><option value="NO">NO</option>'+
